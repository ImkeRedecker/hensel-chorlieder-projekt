<template>
    ...
    <UButton to="/songs/hensel-lockung">Lockung</UButton>
    <UButton to="/songs/hensel-im-wald">Im Wald</UButton>
    <UButton to="/songs/hensel-abendlich-schon">Abendlich Schon</UButton>
